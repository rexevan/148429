...
%\lhead{%
%    \textbf{%
%        Hari, Tanggal Seminar : $haritanggal$ \\
%        Ruang/Sesi/Pukul Seminar : R.$ruang$/$sesi$/$pukul$ WIB\\
%        }
%    }
%\cfoot{\thepage}
...
\usepackage{sectsty}
\sectionfont{\normalfont \fontsize{11pt}{11pt}\selectfont \centering}
...
\begin{center}
    \textbf{$mahasiswa$\(^{*1}\), $dosbing$\(^2\)}\\
    \(^{*1}\)$tingkat$/$nim$ \\
    \vspace{1em}
    e-mail: \(^{*1}\)$emailmahasiswa$, \(^2\)$emaildosbing$\\
\end{center}
